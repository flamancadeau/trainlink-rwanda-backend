...
router.get('/:traineeId', authenticate, (req, res) => applicationController.getApplicationsByTrainee(req, res));
router.get('/:internshipId', authenticate, (req, res) => applicationController.getApplicationsByInternship(req, res));
